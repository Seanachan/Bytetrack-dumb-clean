...
python3 run_mot_challenge.py \
--METRICS HOTA \
--SEQMAP_FILE /home/seanachan/TempRMOT/datasets/data_path/seqmap.txt \
--SKIP_SPLIT_FOL True \
--GT_FOLDER /home/seanachan/data/Dataset/refer-kitti/KITTI/labels_with_ids/image_02 \
--TRACKERS_FOLDER /home/seanachan/TempRMOT/exps/bytetrack/results_epoch51 \
--GT_LOC_FORMAT {gt_folder}{video_id}/{expression_id}/gt.txt \
--TRACKERS_TO_EVAL /home/seanachan/TempRMOT/exps/bytetrack//results_epoch51 \
--USE_PARALLEL True \
--NUM_PARALLEL_CORES 2 \
--SKIP_SPLIT_FOL True \
--PLOT_CURVES False
